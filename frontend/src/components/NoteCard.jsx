...
const NoteCard = ({
  ...
  return (
    <div className='rounded p-4 bg-color-3 hover:shadow-xl transition-all ease-in-out'>
        ...
        <div className='flex items-center justify-between mt-2'>
            ...
            <div className='flex items-center gap-2'>
                ...
                <MdDelete className='icon-btn hover:text-red-600 cursor-pointer' onClick={onDelete} />
            </div>
        </div>
    </div>
  )
